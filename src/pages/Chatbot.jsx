...
const { service, clinique } = location.state || {};
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      try {
        ...
        if (!clinique || typeof clinique !== "string") {
            console.error("Clinique invalide :", clinique);
            return;
          }
          
        await addDoc(
        collection(db, "cliniques",clinique,"chat"),
            {
          ...
          if (!clinique) {
            console.error("Clinique non définie");
            return;
          }        
